...
class CommodityMarketInfoDtoMapperTest {
    ...
    private CommodityMarketInfoDtoMapper underTest;

    @BeforeEach
    public void setUp() {
        underTest = new CommodityMarketInfoDtoMapper(commodityDtoMapper, stationDtoMapper);
    }
    ...
    public void testMap_givenDomainObject_shouldReturnDto() {
        ...
        StationDto mockHighestSellingStationDto = mock(StationDto.class);
        StationDto mockLowestBuyingStationDto = mock(StationDto.class);

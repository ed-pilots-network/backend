...
class MybatisLocateCommodityEntityMapperTest {
    ...
    private MybatisLocateCommodityEntityMapper underTest;
    ...
    public void testMap_givenEntity_shouldReturnDomainObject() {
        ...
        MybatisLocateCommodityEntity entity = MybatisLocateCommodityEntity.builder()
    ...
    public void testMap_givenDomainObject_shouldReturnEntity() {
        ...
        when(mybatisStationEntityMapper.map(domainObject.station())).thenReturn(mockMybatisStationEntity);
        ...
        assertThat(result.getStation(), is(mockMybatisStationEntity));

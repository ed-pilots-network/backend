...
class SystemEntityMapperTest {
    ...
    private SystemEntityMapper underTest;
    ...
    @Test
    public void testMap_givenDomainObject_shouldReturnEntity_nullCoordinate() {
        UUID id = UUID.randomUUID();
        Long eliteId = 123456L;
        String name = "System Name";
        System domainObject = new System(id, eliteId, name, null);
        ...
        assertThat(entity.getEliteId(), is(eliteId));
        assertThat(entity.getName(), is(name));
        assertThat(entity.getXCoordinate(), nullValue());
        assertThat(entity.getYCoordinate(), nullValue());
        assertThat(entity.getZCoordinate(), nullValue());
    }
}
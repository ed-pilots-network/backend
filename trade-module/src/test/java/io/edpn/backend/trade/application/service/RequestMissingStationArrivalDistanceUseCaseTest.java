...
public class RequestMissingStationArrivalDistanceUseCaseTest {
    ...
    public void testFindStationsFilter() {
        ...
        assertThat(RequestMissingStationArrivalDistanceService.FIND_STATION_FILTER, equalTo(findStationFilter));
    }
    ...
    public void testRequestMissingForOneResult() {
        ...
        when(messageMapper.map(argThat(argument -> argument != null && argument.getTopic().equals("stationArrivalDistanceRequest") && argument.getMessage().equals("jsonNodeString")))).thenReturn(messageDto);
    ...
    public void testRequestMissingForMultipleResult() {
        ...
        when(messageMapper.map(argThat(argument -> argument != null && argument.getTopic().equals("stationArrivalDistanceRequest") && argument.getMessage().equals("jsonNodeString1")))).thenReturn(messageDto1);
        when(messageMapper.map(argThat(argument -> argument != null && argument.getTopic().equals("stationArrivalDistanceRequest") && argument.getMessage().equals("jsonNodeString2")))).thenReturn(messageDto2);

...
public class RequestMissingStationArrivalDistanceUseCaseTest {
    ...
    public void testRequestMissingForOneResult() {
        ...
        when(messageMapper.map(argThat(argument -> argument != null && argument.topic().equals("stationArrivalDistanceRequest") && argument.message().equals("jsonNodeString")))).thenReturn(messageDto);
    ...
    public void testRequestMissingForMultipleResult() {
        ...
        when(messageMapper.map(argThat(argument -> argument != null && argument.topic().equals("stationArrivalDistanceRequest") && argument.message().equals("jsonNodeString1")))).thenReturn(messageDto1);
        when(messageMapper.map(argThat(argument -> argument != null && argument.topic().equals("stationArrivalDistanceRequest") && argument.message().equals("jsonNodeString2")))).thenReturn(messageDto2);

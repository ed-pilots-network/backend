...
class CommodityRepositoryTest {
    ...
    @BeforeEach
    void setUp() {
        commodityRepository = new io.edpn.backend.messageprocessor.commodityv3.infrastructure.persistence.repository.CommodityRepository(idGenerator, commodityEntityMapper);
    }

...
public interface KafkaConsumerConfig {
    ...
    class EddnJsonKafkaConsumerConfig {
        ...
        @Bean
        public ConcurrentKafkaListenerContainerFactory<String, JsonNode> eddnFssSignalDiscoveredKafkaListenerContainerFactory(EddnJsonKafkaConsumerConfig kafkaConfig) {
            return kafkaConfig.kafkaListenerContainerFactory("fsssignaldiscovered");
        }
    }
}

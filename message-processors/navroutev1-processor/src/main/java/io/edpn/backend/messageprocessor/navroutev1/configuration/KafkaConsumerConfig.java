...
public interface KafkaConsumerConfig {
    ...
    class EddnJsonKafkaConsumerConfig {
        ...
        @Bean
        public ConcurrentKafkaListenerContainerFactory<String, JsonNode> eddnNavRouteKafkaListenerContainerFactory(EddnJsonKafkaConsumerConfig kafkaConfig) {
            return kafkaConfig.kafkaListenerContainerFactory("navroute");
        }
    }
}

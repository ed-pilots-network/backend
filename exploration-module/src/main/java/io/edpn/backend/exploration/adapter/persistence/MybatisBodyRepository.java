...
public interface MybatisBodyRepository {
    ...
    @Select({"INSERT INTO body (id, arrival_distance, ascending_node, atmosphere, atmospheric_composition, axial_tilt, body_composition," +
            ...
            "#{orbitalInclination}, #{orbitalPeriod}, #{parents}, #{periapsis}, #{planetClass}, #{radius}, #{rotationPeriod}," +
            ...
            "ON CONFLICT (name, system_id) " +
                    ...
                    "parents = COALESCE(body.parents, EXCLUDED.parents)," +
    ...
    @Results(id = "bodyResultMap", value = {
            ...
            @Result(property = "parents", column = "parents", javaType = Map.class, typeHandler = IntegerStringMapTypeHandler.class),

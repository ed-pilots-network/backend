package io.edpn.backend.messagelistener.configuration;

import io.edpn.backend.messagelistener.infrastructure.zmq.EddnMessageHandler;
import io.edpn.backend.messagelistener.infrastructure.zmq.OnlyNewMessageSelector;

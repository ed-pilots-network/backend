...
import io.edpn.edpnbackend.infrastructure.persistence.mappers.StationEntityMapper;
...
public class StationRepository implements io.edpn.edpnbackend.domain.repository.StationRepository {

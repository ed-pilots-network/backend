...
import io.edpn.edpnbackend.infrastructure.persistence.mappers.StationSystemEntityMapper;
...
public class StationSystemRepository implements io.edpn.edpnbackend.domain.repository.StationSystemRepository {
